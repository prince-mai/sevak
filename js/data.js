...
const SEVAK_I18N = {
  en: {
    heroTag: "BIHAR'S #1 TRUSTED SERVICE SUPER-PLATFORM",
    heroHeading: "One Platform, Every Service",
    heroSubheading: "Professional Electrical, Plumbing, Civil, Construction, AMC & B2B Solutions for Homes, Societies, Hospitals & Businesses across Patna & Bihar.",
    bookNow: "Book Instant Service",
    requestQuote: "Request Project Quote",
    emergencySos: "Need Urgent Help in 30 Mins?",
    trackLive: "Track Technician Live",
    ...
    trustedBy: "Trusted by 25,000+ Homes & 450+ Institutions in Bihar",
  ...
  hi: {
    heroTag: "बिहार का नंबर १ सबसे भरोसेमंद सुपर-सर्विस नेटवर्क",
    ...
    trackLive: "टेक्नीशियन को लाइव ट्रैक करें",
    ...
    trustedBy: "बिहार के २५,०००+ परिवारों और ४५०+ संस्थानों का भरोसा",
